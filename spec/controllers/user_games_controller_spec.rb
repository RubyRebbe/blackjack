  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_game as @user_game" do
        ...
        post :create, {:user_game => {}}, valid_session
        assigns(:user_game).should be_a_new(UserGame)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_game" do
        ...
        UserGame.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => user_game.to_param, :user_game => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the user_game as @user_game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserGame.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_game.to_param, :user_game => {}}, valid_session
        assigns(:user_game).should eq(user_game)
      end
